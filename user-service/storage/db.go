...
func (s *UserRepo) Register(ctx context.Context, req *proto.RegisterRequest) (*proto.RegisterResponse, error) {
	id := uuid.New().String()
...
func (s *UserRepo) GetUser(ctx context.Context, req *proto.GetUserRequest) (*proto.GetUserResponse, error) {
...
func (s *UserRepo) UpdateUser(ctx context.Context, req *proto.UpdateUserRequest) (*proto.UpdateUserResponse, error) {
...
func (s *UserRepo) DeleteUser(ctx context.Context, req *proto.DeleteUserRequest) (*proto.DeleteUserResponse, error) {
...
func (s *UserRepo) Login(ctx context.Context, req *proto.LoginRequest) (*proto.LoginResponse, error) {
